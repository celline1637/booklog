...
export type RHFSwitchProps = Omit<
  ...
  return (
    <Controller
      ...
      render={({ field, fieldState: { error } }) => {
        // 동적 라벨이 있으면 값에 따라 결정, 없으면 기본 라벨 사용
        const displayLabel = dynamicLabel
          ? field.value
            ? dynamicLabel.checked
            : dynamicLabel.unchecked
          : label;
            ...
            <FormControlLabel
              control={
                <Switch
                  ...
                  {...slotProps?.switch}
                  inputProps={{
                    ...(!displayLabel && { "aria-label": ariaLabel }),
